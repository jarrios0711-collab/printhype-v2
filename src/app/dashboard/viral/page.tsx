    ...
    return (
        <div className="space-y-10 max-w-7xl mx-auto">
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-3xl font-black tracking-tight">Viral Cockpit</h1>
                    <p className="text-neutral-500 text-sm mt-1">Control de contenido viral y automatización de marketing JR3D.</p>
                </div>
                <button className="flex items-center gap-2 px-6 py-3 bg-brand-orange text-black rounded-xl text-xs font-black hover:scale-105 transition-all shadow-lg shadow-brand-orange/20">
                    <Zap size={16} /> GENERAR NUEVA CAMPAÑA
                </button>
            </div>
            ...
            <div className="bg-neutral-950/40 border border-neutral-900 rounded-3xl p-8 backdrop-blur-md">
                ...
                <div className="space-y-4">
                    {campaigns.map((camp) => (
                        <div key={camp.id} className="flex items-center justify-between p-5 bg-white/5 border border-white/5 rounded-2xl hover:bg-white/[0.08] transition-all group">
                            <div className="flex items-center gap-6">
                                <div className="w-16 h-16 rounded-xl bg-neutral-900 flex items-center justify-center relative overflow-hidden border border-neutral-800">
                            ...
                            <div className="flex items-center gap-12">
                                <div className="text-center">
                                    ...
                                    <div className="text-lg font-black">{camp.views === '-' ? 'PEND' : camp.views}</div>
                                </div>
                                <div className="w-32">
                                ...
                                <button className="p-3 bg-neutral-900 rounded-xl hover:bg-neutral-800 hover:text-brand-orange transition-all">
